    ...
    public class MySpellManager
    {
        public static void Initializer()
        {
            try
            {
                ...
                MyLogic.Q.SetSkillshot(Q1Delay, 30f, float.MaxValue, false, false, SkillshotType.Line);

                MyLogic.Q3 = new Spell(SpellSlot.Q, 1000f);
                MyLogic.Q3.SetSkillshot(Q3Delay, 90f, 1200f, false, true, SkillshotType.Line);
